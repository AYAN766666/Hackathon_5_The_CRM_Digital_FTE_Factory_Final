      ...
      <body>
        <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-3xl">
            ...
            >
              Don't worry - our team has been notified and we're fixing it!
            </motion.p>
            ...
            >
              <div className="p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 max-w-md mx-auto">
                ...
                <p className="text-gray-300 text-sm font-mono bg-black/20 p-3 rounded-lg overflow-x-auto text-left">
            ...
            >
              <div className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                ...
                />
                <span className="text-gray-300 text-sm">System: Operational</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full">
                <motion.div
                  animate={{ scale: [1, 1.2, 1] }}
                ...
                />
                <span className="text-gray-300 text-sm">Support: Available</span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-8 p-6 bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-md rounded-2xl border border-white/10 max-w-lg mx-auto"
            >
              <motion.div
